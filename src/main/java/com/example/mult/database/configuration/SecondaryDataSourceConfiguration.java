package com.example.mult.database.configuration;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.example.mult.database.repository.secondary"})
public class SecondaryDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean secondaryEntityManagerFactory(
        ...
        return secondaryEntityManagerFactoryBuilder
                ...
                .packages("com.example.mult.database.entity.secondary")
